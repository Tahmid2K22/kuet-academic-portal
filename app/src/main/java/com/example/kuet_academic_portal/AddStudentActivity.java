...
public class AddStudentActivity extends AppCompatActivity {
    ...
    private EditText etRoll, etName, etDepartment, etTerm, etYear, etSection, etEmail, etPhone;
    ...
    private void addStudent() {
        ...
        try {
            ...
            if (!phone.isEmpty()) {
                ...
                if (!numericPhone.isEmpty()) {
                     try {
                        ...
                        student.put("phone", phone); // Fallback to storing original string if parsing fails
                     }
                } else {
                     student.put("phone", "");
                }
            ...
            Toast.makeText(this, "Invalid number format in Roll, Term or Year", Toast.LENGTH_SHORT).show();
        }
    }
